                                ...
                                <select name="table" class="form-control">
                                    ...
                                    foreach ($this->GETTABLES("Rock_") as $k => $table) {
                                        ...
                                        if (isset($_REQUEST['table'])) {
                                            if ($_REQUEST['table'] == $table['Tables_in_project_rock (%Rock_%)']) {
                                        ...
                                        ?>
                                        <option value="<?= $table['Tables_in_project_rock (%Rock_%)'] ?>" <?= $table_selected ?>><?= $table['Tables_in_project_rock (%Rock_%)'] ?></option>
                                        <?php
                                    }
                                    ?>
